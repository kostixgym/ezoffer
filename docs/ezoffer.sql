...
CREATE TABLE "interviews" (
	...
	UNIQUE("slug"),
	UNIQUE("sourceId"),
	CONSTRAINT "chk_interviews_grades" CHECK("grades" <@ ARRAY['junior','middle','senior','lead']::text[]),
	CONSTRAINT "chk_interviews_types" CHECK("types" <@ ARRAY['technical','liveCoding','algorithmic','hrScreening','final','systemDesign']::text[]),
...
CREATE TABLE "tasks" (
	...
	UNIQUE("slug"),
	UNIQUE("sourceId"),
	CONSTRAINT "chk_tasks_grades" CHECK("grades" <@ ARRAY['junior','middle','senior','lead']::text[]),
...
CREATE TABLE "testAssignments" (
	...
	UNIQUE("slug"),
	CONSTRAINT "chk_testAssignments_grades" CHECK("grades" <@ ARRAY['junior','middle','senior','lead']::text[])
);
