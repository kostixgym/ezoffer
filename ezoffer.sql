...
CREATE TABLE "interviews" (
	...
	UNIQUE("slug"),
	CONSTRAINT "chk_interviews_grade" CHECK("grade" IS NULL OR "grade" = ANY (ARRAY['junior','middle','senior','lead'])),
	CONSTRAINT "chk_interviews_type" CHECK("type" IS NULL OR "type" = ANY (ARRAY['technical','liveCoding','algorithmic','hrScreening','final','systemDesign'])),
	CONSTRAINT "chk_interviews_video" CHECK("youtubeUrl" IS NOT NULL OR "vfsPath" IS NOT NULL)
);
...
CREATE INDEX "ix_interviews_grade" ON "interviews" (
	"grade"
);

CREATE INDEX "ix_interviews_type" ON "interviews" (
	"type"
);
